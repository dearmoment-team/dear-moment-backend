...
class UpdateProductUseCaseTest : BehaviorSpec({
    ...
    val updateRequest = UpdateProductRequest(
        ...
        mainImageFile = MockMultipartFile(
            "mainImageFile",
            "new_main.jpg",
            "image/jpeg",
    ...
    Given("updateProduct 메서드") {
        ...
        When("정상 요청 시") {
            ...
            every { imageHandler.processSubImagesFinal(any(), any(), any()) } returns listOf(
                dummyExistingSubImage,
                dummyNewSubImage1,
                dummyNewSubImage2,
                dummyNewSubImage1
            ...
            every { productPersistencePort.save(any()) } returns existingProduct.copy(
                title = "Updated Title",
                description = "Updated Description",
                ...
                subImages = listOf(dummyExistingSubImage, dummyNewSubImage1, dummyNewSubImage2, dummyNewSubImage1),
