...
class ProductRestAdapterTest {
    ...
    fun `상품 생성 API 테스트`() {
        ...
        // given: 요청 객체 (shootingTimeMinutes=10 → 10분)
        ...
        // given: 응답 객체 (shootingTimeMinutes=10)
        val productResponse = ProductResponse(
            ...
            shootingTimeMinutes = 10,  // 응답도 분 단위
        ...
        // multipart 요청
        val requestBuilder = MockMvcRequestBuilders.multipart("/api/products")
            .file(requestPart)
            .file(imageFile)
        ...
        mockMvc.perform(requestBuilder)
            ...
            .andDocument(
                ...
                responseBody(
                    ...
                    // shootingTimeMinutes: 분 단위로 문서화
                    "data.shootingTimeMinutes" type NUMBER means "촬영 시간 (분)",
    ...
    fun `상품 수정 API 테스트`() {
        ...
        // given: 수정 요청 (shootingTimeMinutes=10)
        ...
        // given: 수정 후 반환될 응답 (shootingTimeMinutes=10)
        val productResponse = ProductResponse(
        ...
        val requestBuilder = MockMvcRequestBuilders.multipart("/api/products/{id}", updateRequest.productId)
            .file(requestPart)
            .file(imageFile)
            .with { req ->
    ...
    fun `getProduct - 성공`() {
        ...
        // given: ProductResponse에 분 단위로 표기
        val productResponse = ProductResponse(
            productId = productId,
            userId = 1L,
            title = "Test Product",
        ...
        mockMvc.perform(
            ...
            .andDocument(
                ...
                responseBody(
                    ...
                    // shootingTimeMinutes
                    "data.content[].shootingTimeMinutes" type NUMBER means "촬영 시간 (분)",
