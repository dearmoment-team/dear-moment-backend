...
internal class ProductTest : StringSpec({
    ...
    "새로운 필드들(concept, provideOriginal, shootingTime, shootingLocation, numberOfCostumes, seasonYear, seasonHalf, detailedInfo, warrantyInfo, contactInfo)이 올바르게 설정되어야 한다" {
        // given
